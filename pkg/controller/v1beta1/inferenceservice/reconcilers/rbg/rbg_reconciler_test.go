...
func TestBuildRole_RawDeployment(t *testing.T) {
	...
	assert.Equal(t, rbgconstants.DeploymentWorkloadType, role.Annotations[rbgconstants.RoleWorkloadTypeAnnotationKey])
...
func TestBuildRole_MultiNode(t *testing.T) {
	...
	assert.Equal(t, rbgconstants.LeaderWorkerSetWorkloadType, role.Annotations[rbgconstants.RoleWorkloadTypeAnnotationKey])
