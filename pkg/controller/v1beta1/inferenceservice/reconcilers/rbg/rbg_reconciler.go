...
import (
	...
	rbgconstants "sigs.k8s.io/rbgs/api/workloads/constants"
...
func buildRole(cfg *components.RoleConfig) (rbgv1alpha2.RoleSpec, error) {
	...
	case constants.RawDeployment:
		setRoleAnnotation(&role, rbgconstants.RoleWorkloadTypeAnnotationKey, rbgconstants.DeploymentWorkloadType)
	...
	case constants.MultiNode:
		...
		setRoleAnnotation(&role, rbgconstants.RoleWorkloadTypeAnnotationKey, rbgconstants.LeaderWorkerSetWorkloadType)
...
func setRoleAnnotation(role *rbgv1alpha2.RoleSpec, key, value string) {
